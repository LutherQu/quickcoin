...
If you have Microsoft Security Essentials, you need to add quickcoin-qt.exe to its
"Excluded processes" list.  Microsoft Security Essentials->Settings tab,
select Excluded processes, press Add, select quickcoin-qt.exe, OK, Save changes.
